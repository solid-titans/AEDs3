...
/**
 * Classe que mistura a Input.java e as classes em menu.sistema.graficos, para criar sistemas
 * de entradas customizadas
...
public class CustomInput extends Input implements CustomInputInterface{
    ...
    public CustomInput(ASCIInterface graficos, ANSILibrary destaqueTamMax, ANSILibrary destaqueTamMin, ANSILibrary destaqueObs) {
        super();
    ...
    public String inserir(String titulo,int limMin, int limMax,boolean printRestr) {
        ...
        do {         
            ...
            System.out.println(destaqueObs.imprimir("OBS: Deixe o espaço em branco e pressione \'Enter\' para cancelar o processo"));
      ...
      public String inserir(String titulo,String observacao, int limMin, int limMax,boolean printRestr) {
          ...
          do { 
              System.out.print(graficos.caixa(titulo) + destaqueObs.imprimir(observacao) + "\n" + 
                                                        destaqueObs.imprimir("OBS: Deixe o espaço em branco e pressione \'Enter\' para cancelar o processo")  + "\n"  );
      ...
      private String imprimirTamanhoMinMax(int menor, int maior) {
          return destaqueTamMin.imprimir("Tamanho mínimo: " + menor)+ ";" + destaqueTamMax.imprimir("Tamanho máximo: " + maior);
      }
}
